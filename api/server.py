...
<header>
  <div>
    <h1><span class="brand-icon">&#10022;</span> Doctor.AI <span style="font-size:12px;color:#73DB00;font-weight:700;">PRO</span></h1>
      ...
      <div class="ai-message-card">
        <div class="ai-header">
          <div style="display:flex;align-items:center;gap:10px;">
            ...
            <div>
              <div style="font-weight:800;font-size:14px;color:#161D13;">Doctor.AI</div>
        ...
        <div class="output" id="rag-output">Welcome to Doctor.AI! Ask any clinical question below to receive verified medical guidance.</div>
